...
//    private void showRecyclerDetailView(){
//        rvRempah.setLayoutManager(new LinearLayoutManager(this));
//        DetailViewRempahAdapter detailViewRempahAdapter = new DetailViewRempahAdapter(list);
//        rvRempah.setAdapter(detailViewRempahAdapter);
//    }
